...
- Ex-DGSE — je pourrais vous raconter, mais après il faudrait… enfin vous connaissez la suite
...
```text
2023 - …………  ⇝  CTPO Sinfin — PIM/DAM SaaS pour le retail (LVMH, Lacoste, Le Coq Sportif, …)
2021 - 2023  ⇝  Co-fondateur & CTO TimCity — ERP immobilier from scratch (Melun)
2012 - 2015  ⇝  Ingénieur R&D / Sécurité — DGSE (Paris) 🤫
2010 - 2012  ⇝  Ingénieur R&D & Tech Lead — SaaS e-santé / HAD (Bordeaux)
2010 - …………  ⇝  CEO x10 — Ma boîte, mon bébé (SARL → SAS)
```

J'ai commencé dans une startup bordelaise en e-santé, enchaîné à la DGSE, transformé mes soirées libres en micro-entreprise, puis en SARL, puis en SAS. Quelques grands comptes et une quantité déraisonnable de `composer update` plus tard, me voilà CTPO d'un éditeur SaaS.
